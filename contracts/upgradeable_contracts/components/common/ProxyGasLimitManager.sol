...
/**
 * @title ProxyGasLimitManager
 * @dev Functionality for determining the request gas limit for AMB execution.
 */
abstract contract ProxyGasLimitManager is BasicAMBMediator, SelectorTokenGasLimitConnector {
    ...
    function requestGasLimit() public view returns (uint256) {
        ...
        if (address(gasLimitManager()) == address(0)) {
